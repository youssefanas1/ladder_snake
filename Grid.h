...
public:
	...
	Player* GetNearestPlayer(Player* pPlayer);
	...
	Snake* GetNextSnake(const CellPosition& position) const;// r.Gets a Pointer to the first Snake after the passed "position"
	Card* GetNextCard(const CellPosition& position) const;//r. Gets a Pointer to the first Card after the passed "position"
	Card* GetCard(const CellPosition& position) const; // r.Gets a Pointer to the Card of the passed "position"
	Ladder* GetLadder(const CellPosition& position) const; //r. Gets a Pointer to the Ladder of the passed "position"
	GameObject* GetObjectinCell(const CellPosition& pos);
	Snake* GetSnake(const CellPosition& position) const; //r. Gets a Pointer to the Snake of the passed "position"
